  ...
  return (
    <div className="flex flex-col h-full w-full">
      <Image
        ...
        quality={100}
      />
      <div className="flex flex-col z-10 mx-[25px] tablet:mx-[50px] laptop:mx-[70px] w-[80%] laptop:w-[50%] h-screen justify-end laptop:justify-center pb-[75px] tablet:pb-[150px] laptop:pb-0 ">
